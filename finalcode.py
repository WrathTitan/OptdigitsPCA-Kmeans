...
#This accuracy is without applying PCA to the dataset. It is by directly applying Kmeans classifier to the dataset
measuring_accuracy(Centroids,test_data,test_label)

#Now Applying PCA to the dataset and hence finding the features that explain 90% variance
...
#This is the accuracy obtained by applying PCA to the dataset and then applying the Kmeans classifier
measuring_accuracy(Centroids,test_data,test_label)